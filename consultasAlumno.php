    ...
    <body class="scroll-assist">
        ...
        <div class="main-container transition--fade">
            <section class="height-70 bg--dark imagebg page-title page-title--animate parallax" data-overlay="6">
                ...
                <h3 class="text-dark mb-4">¡No te quedes con la duda!</h3>
                <div class="card shadow">
                    <div class="card-header py-3">
                        <p class="text-primary m-0 font-weight-bold">¡Pregúntale a tu profe! Será anónimo 🕵️‍ </p>
                    </div>
                   <form method="post">
                     
                             <textarea name="texto" rows="4" cols="40" placeholder="Escriba algo..." style="background: #C96E22;"></textarea> <input type="submit" value="Preguntar" style="position: absolute; right: 0%;" name="consultar">
                             <?php 
                                    if (isset($_POST['consultar'])) {
                                        $file=fopen('consultasPrivadas.txt', 'a');
                                        fwrite($file, $_GET['con']."#".$_POST['texto'].PHP_EOL);
                                        fclose($file);
