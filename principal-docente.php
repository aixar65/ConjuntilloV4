                ...
                <div class="container pos-vertical-center">
                    <div class="row">
                        <div class="col-sm-10 col-sm-offset-1 text-center">
                            <h3>Bienvenido/a</h3>
                            <p class="lead">Puedes empezar tu clase compartiendo el PIN con tus alumnos. ¡Se encuentra aquí abajo!</p> <label class="page-scroll shortcode_button btn_large btn_type2" style="text-decoration: none; padding: 10px; font-weight: 600; font-size: 20px; color: #ffffff; background-color: #1883ba; border-radius: 6px; border: 2px solid #0016b0;"> ⟹ <?php if (isset($_GET['pin'])) {
                                echo $_GET['pin'];
                            } ?> ⟸ </label>
                        </div>
