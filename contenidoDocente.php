                                        ...
                                        <ul class="multi-column">
                                            <li>
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="contenidoDocente.php?pin=<?php echo $_GET['pin']; ?>&tema=1">
                                                            Unión
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="contenidoDocente.php?pin=<?php echo $_GET['pin']; ?>&tema=2">
                                                            Intersección
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="contenidoDocente.php?pin=<?php echo $_GET['pin']; ?>&tema=4">
                                                            Complemento
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="contenidoDocente.php?pin=<?php echo $_GET['pin']; ?>&tema=3">
                                                            Inclusión
                                                        </a>
                                                    </li>
                                                </ul>
