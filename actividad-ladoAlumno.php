...
<html lang="en">
    <head>
        ...
        <style type="text/css">
            .raios:hover {background: #009ACF;color:white}
            label::selection {
            background: blue;
            color: white;
    ...
    <body class="scroll-assist" >
       <div class="nav-bar nav--absolute nav--transparent" data-fixed-at="200">
        ...
        <div class="main-container transition--fade">
                                    ...
                                    <li>
                                        ...
                                        <ul class="multi-column">
                                            <li>
                                                <ul>
                                                    <li>
                                                        <a href="actividad-ladoAlumno.php?con=<?php echo $_GET['con']; ?>&&tema=5">
                                                            Introducción
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="actividad-ladoAlumno.php?con=<?php echo $_GET['con']; ?>&tema=1">
                                                            Unión
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="actividad-ladoAlumno.php?con=<?php echo $_GET['con']; ?>&tema=2">
                                                            Intersección
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="actividad-ladoAlumno.php?con=<?php echo $_GET['con']; ?>&tema=4">
                                                            Complemento
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="actividad-ladoAlumno.php?con=<?php echo $_GET['con']; ?>&tema=3">
                                                            Inclusión
                                                        </a>
                                                    </li>
                                                </ul>
            ...
            <div class="login-box">
             <div class="logo">
                <a href="javascript:void(0);"><b>ACTIVIDADES</b></a>
           
            </div>
            
                <?php
                $fileR=fopen('preguntas_resp.txt', 'r');
                ...
                while (!feof($fileR)) {
                    $text=explode('#', fgets($fileR));
                        # code...
                    if (!empty($text[0]) && !empty($text[1]) && !empty($text[2]) && !empty($text[3]) && !empty($text[4]) && !empty($text[5]) && !empty($text[6])) {
                        if (intval($text[5])==intval($codigoGet)) {
                        # code...
                 ?><div class="card">
                    <hr style="opacity: 20%;">
                    ...
                    <div class="body">
                        ...
                        <form id="iniciarsesion"  method="POST">
                            ...
                            <label class="raios" style="color: #F6F6F6; padding: 10px;"><input style="display: block !important;" type="radio" name="eq" value="1"><?php echo $text[3];  ?></label>
                            <label class="raios" style="color: #F6F6F6;padding: 10px; "><input style="display: block !important;" type="radio" name="ver" value="1"><?php echo $text[2]; ?></label>
                            <label class="raios" style="color: #F6F6F6;padding: 10px;"><input style="display: block !important;" type="radio" name="eq" value="1"><?php echo $text[4]; ?></label>
                            <div class="row"> 
                        <div class="col-xs-12">
                            <input name="iniciarAct" class="btn btn-block bg-pink waves-effect" type="submit" value="Confirmar"style="font-size: 0.62em !important; height: 52px; letter-spacing: 1px; border-radius: 100px; width: 200px; margin-left: auto; "/>
                        </div>
                    </div>
                        <?php 
                            if (isset($_POST['iniciarAct'])) {
                                if (isset($_POST['ver'])) {
                                ?>
                                <h2> re bien na marcaste</h2>
                                <?php 
                                }else{
                                ?>
                                <h2> re mal na marcaste</h2>
