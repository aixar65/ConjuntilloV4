    ...
    <body class="scroll-assist">
        ...
        <div class="main-container transition--fade">
            ...
            <div class="container pos-vertical-center" style="height: 90%;">
                ...
                <h3 class="text-dark mb-4">¡Debate con tus compañeros!</h3>
                <div class="card shadow">
                    <div class="card-header py-3">
                        <p class="text-primary m-0 font-weight-bold">Escribe en el muro y comparte el conocimiento con tus amigos 🕵️‍ </p>
                    </div>
                   <form method="post">
                     
                             <textarea name="texto" placeholder="Escriba algo..." style="background: #C96E22;"></textarea> 
                             <input type="submit" value="Enviar" style="position: absolute; right: 0%;" name="consultar">
                             <?php 
                                    if (isset($_POST['consultar'])) {
                                        $file=fopen('foroConsultas.txt', 'a');
                                        fwrite($file, $_GET['con']."#".$_GET['name']."#".$_POST['texto'].PHP_EOL);
                                        fclose($file);
            ...
            <section class="height-70 bg--dark imagebg page-title page-title--animate parallax" data-overlay="6">
                 ...
                 <!--en teoria aca tendria que ir el foro-->
                
                   <div class="container pos-vertical-center" style="height: 100%;">
              
                <div class="container-fluid" style="position: absolute; left: 10%; right: 10%;">
                <h3 class="text-dark mb-4">¡Mirá el foro!</h3>
                <?php 
                  $fileR=fopen('foroConsultas.txt','r');
                  while (!feof($fileR)) {
                    $pin=$_GET['con'];
                    $text=explode('#', fgets($fileR));
                    if ($text[0]==$pin && !empty($text[2]) && !empty($text[1])) {
                 ?>
                <div class="card shadow">
                <hr>
                        <div class="form-line">
                          ...
                          <input type="submit" value="Responder" style="position: absolute; right: 0%;">
                </hr>
                </div>
